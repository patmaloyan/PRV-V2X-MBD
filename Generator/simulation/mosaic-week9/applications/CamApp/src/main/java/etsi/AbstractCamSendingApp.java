...
import org.eclipse.mosaic.fed.application.app.etsi.ChargingStationCamSendingApp;
import org.eclipse.mosaic.fed.application.app.etsi.RoadSideUnitCamSendingApp;
import org.eclipse.mosaic.fed.application.app.etsi.TrafficLightCamSendingApp;
 ...
 */
public abstract class AbstractCamSendingApp<OS extends OperatingSystem & AdHocCommunicative> extends ConfigurableApplication<ConfigSettings, OS> implements CommunicationApplication {
    ...
    protected AbstractCamSendingApp() {
        this(ConfigSettings.class, "EtsiApplication");
    }
     ...
     */
    protected AbstractCamSendingApp(Class<? extends ConfigSettings> configClass, String configFileName) {
    ...
    /**
     * Checks if Vehicle is in defined simulation area
     */
    public abstract boolean isInSimulationArea();

    /**
     * Checks if Simulation is in defined time
     */
    public abstract boolean isInSimulationTime();
     ...
     */
    private CheckDelta checkMaxDelta(final Data oldData, final Data newData, final ConfigSettings maxDelta) {
    ...
    public static class Data {
        ...
        /**
         * Acceleration of ETSI_unit in m/s²
         */
        ...
        /**
         * Alias used for sending the message
         */
        public long alias = (long) ((Math.random() * 9_000_000_000L) + 1_000_000_000L);
        /**
         * SpeedMode used for this vehicle
         */
        public SpeedMode speedMode;
        public CartesianPoint cartesianPoint;
    }
